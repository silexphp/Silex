...
At the heart of Silex is simplicity so there is no out of the box solution to use YAML files for validation.
But this doesn´t mean that this is not possible. Let´s see how to do it.

First, you need to install the YAML Component. If you want to take adventage of the autoloading mechanism you should clone https://github.com/symfony/Yaml into ``vendor/Symfony/Components``.
...
Now, we can remove the static method in the Post class and move all these rules to ``validation.yml`` like this::
